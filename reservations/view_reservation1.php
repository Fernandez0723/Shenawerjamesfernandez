...
.total-amount p, .payment-details p {
    font-size: 16px;
    margin: 5px 0;
}
.back-button {
...
@media print {
    .back-button, .print-button {
        display: none;  /* Hides both the buttons during printing */
    }
    .receipt-container {
        box-shadow: none;  /* Optional: remove shadow on print */
        border: 1px solid #000;  /* Optional: add a border to the printed container */
    }
}
...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="total-amount">
            <p><strong>Total Amount:</strong> ₱<?= number_format(htmlspecialchars($reservation['total_amount']), 2) ?></p>
        </div>
        
        <!-- Payment Details Section -->
        <div class="payment-details">
            <p><strong>Payment Status:</strong> <?= ucfirst(htmlspecialchars($reservation['status'])) ?></p>
        </div>
